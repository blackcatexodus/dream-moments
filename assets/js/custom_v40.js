$(document).ready(function () {
	...
	$(document).on('click', '.js-gift-buy-modal', function (e) {
		e.preventDefault();
		console.log($(this).parent().parent().parent().find('.product-option-block'), 'product-option-block')
	...
	// 
	$(document).on('click', '.js-gift-buy-modal-mob', function (e) {
		e.preventDefault();
		console.log($(document).find('.product-option-block'), 'product-option-block')

		$('#modal-price-list').html('');
		$(document).find('.product-option-block').clone().appendTo('#modal-price-list');
		$('#modal-price-list .product-option-block').removeClass('hidden');
